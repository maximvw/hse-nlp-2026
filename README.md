...
Бот доступен в тг по ссылке @videoassistentytbot. После запуска он ждёт ссылку на YouTube-видео в диалоге. Видео обрабатывается автоматически, затем можно задавать вопросы.
